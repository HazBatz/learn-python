...
class DoorSprite(Sprite):
    def __init__(self, game, photo_image, x, y, width, height):
        Sprite.__init__(self, game)
        self.closed_door = PhotoImage(file='img\\door1.gif')
        self.photo_image = photo_image
        self.image = game.canvas.create_image(x, y, \
                image=self.photo_image, anchor='nw')
...
g = Game()
platform1 = NonMovingSprite(g, PhotoImage(file='img\\platform1.gif'), \
    0, 480, 100, 10)
platform2 = NonMovingSprite(g, PhotoImage(file='img\\platform1.gif'), \
    150, 440, 100, 10)
platform3 = NonMovingSprite(g, PhotoImage(file='img\\platform1.gif'), \
    300, 400, 100, 10)
platform4 = NonMovingSprite(g, PhotoImage(file='img\\platform1.gif'), \
    300, 160, 100, 10)
platform5 = MovingPlatformSprite(g, PhotoImage(file='img\\platform2.gif'), \
    175, 350, 66, 10)
platform6 = NonMovingSprite(g, PhotoImage(file='img\\platform2.gif'), \
    50, 300, 66, 10)
platform7 = NonMovingSprite(g, PhotoImage(file='img\\platform2.gif'), \
    170, 120, 66, 10)
platform8 = NonMovingSprite(g, PhotoImage(file='img\\platform2.gif'), \
    45, 60, 66, 10)
platform9 = MovingPlatformSprite(g, PhotoImage(file='img\\platform3.gif'), \
    170, 250, 32, 10)
platform10 = NonMovingSprite(g, PhotoImage(file='img\\platform3.gif'), \
    230, 200, 32, 10)
